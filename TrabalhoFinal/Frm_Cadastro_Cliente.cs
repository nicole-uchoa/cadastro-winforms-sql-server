...
namespace TrabalhoFinal
{
    public partial class Frm_Cadastro_Cliente : Form
    {
        public Frm_Cadastro_Cliente()
        {
            ...
            #region Definição nome dos campos
        ...
        private void Txt_CEP_Leave(object sender, EventArgs e)
        {
            ...
            if (vCep != "")
            {
                if (vCep.Length == 8)
                {
                    ...
                    {
                        var vJson = Fcs_Complementares.GeraJSONCEP(vCep);
        ...
        private void ApagatoolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Cliente.Unit C = new Cliente.Unit();
                    C = C.BuscarSQLREL(Txt_Codigo.Text);
                    if (C == null)
                    {
                        MessageBox.Show("Identificador não encontrado.", "ByteBank", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    }
                    ...
                    {
                        EscreveFormulario(C);
                        Frm_Confirma Db = new Frm_Confirma();
                        Db.ShowDialog();
        ...
        private void salvarToolStripButton_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    Cliente.Unit C = new Cliente.Unit();
                    C = LeituraFormulario(); //ler o que foi preenchido no formulario e salta em cliente.unit
                    //C.ValidaClasse();
                    //C.ValidaComplemento();
                    C.AlterarSQLREL(); //altera os dados
        ...
        //mostrar os dados do código dado
